...
for (const key in ephemeride) {
    if (Object.hasOwnProperty.call(ephemeride, key)) {
        const element = ephemeride[key];
        console.log("element calendrier", element.length)
    }
}

const createCalendar = (annee, data) => {
    console.log("annee ", annee);
    console.log("data ", data);

    console.log("bissextile", isBissextile(annee));
    return `
        <div>Janvier</div>
        <div>Février</div>
        <div>Mars</div>
